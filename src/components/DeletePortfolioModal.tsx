...
const DeletePortfolioModal: React.FC<DeletePortfolioModalProps> = (props: DeletePortfolioModalProps) => {
  return (
      ...
      <div className="modal-box bg-white rounded-2xl p-6 max-w-sm w-full shadow-xl border border-gray-100">
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-gray-900 font-bold text-base">Delete portfolio</h3>
          </div>
          <button
        ...
        <p className="text-sm text-gray-600 mb-1">
          ...
          <span className="font-semibold text-gray-900">"{props.portfolioName}"</span>.
        </p>
        <p className="text-sm text-gray-600 mb-5">
          This portfolio contains{" "}
          <span className="font-semibold text-gray-900">
            {props.assetCount === null ? "…" : props.assetCount}{" "}
            {props.assetCount === 1 ? "transaction" : "transactions"}
          </span>
